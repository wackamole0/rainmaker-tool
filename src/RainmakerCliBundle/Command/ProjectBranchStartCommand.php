...
class ProjectBranchStartCommand extends RainmakerCommand
{
    ...
    protected function configure()
    {
        ...
        $this
            ->setName('project:branch:start')
            ->setDescription('Start a Rainmaker project branch container')
            ->addArgument(
                'name',
    ...
    {
        return new \Rainmaker\Task\ProjectBranch\Start();
    }
